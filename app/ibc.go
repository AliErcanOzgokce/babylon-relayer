...
import (
	...
	btcstakingmodule "github.com/AliErcanOzgokce/babylon-relayer/x/btcstaking/module"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	btcstakingIBCModule := ibcfee.NewIBCMiddleware(btcstakingmodule.NewIBCModule(app.BtcstakingKeeper), app.IBCFeeKeeper)
	ibcRouter.AddRoute(btcstakingmoduletypes.ModuleName, btcstakingIBCModule)
